...
computeDailySubscriptionReports = async(req, res) => {
    ...
    * */
    ...
    console.log('getSubscriptionsByDateRange -> day : ', Number(day), Number(req.day), Number(month), Number(helper.getDaysInMonth(month)));
    ...
    if (Number(req.day) <= Number(helper.getDaysInMonth(month))){
        ...
        console.log('getSubscriptionsByDateRange -> month : ', Number(month), Number(req.month), new Date().getMonth());
